        ...
        (function (CognitiveServices) {
            (function (SpeechRecognition) {
                ...
                (function (SpeechRecognitionServiceFactory) {
                    ...
                    SpeechRecognitionServiceFactory.BaseSpeechUrl = "https://websockets.platform.bing.com/ws/speech/recognize"; //https://speech.platform.bing.com/recognize
    ...
    (function (Bing) {
        ...
        var HttpClient = (function () {
            function HttpClient(waveFormat) {
                if (typeof waveFormat === "undefined") {
                    waveFormat = WaveFormat.PcmFloat;
                }
                this.queue = [];
            ...
            HttpClient.prototype.tts = function (text, contentType, outputFormat) {
                ...
                if (contentType === "text/plain") {
                    text = "<?xml version='1.0' encoding='UTF-8'?>" + "<speak version='1.0' xml:lang='en-US'>" + "<voice xml:lang='en-US' name='" + Bing._defaultVoiceName + "'>" + text + "</voice></speak>";
            ...
            HttpClient.prototype.getToken = function () {
                if (!this.auth) {
                    ...
                    //fixme !!!
                    /*this.preferences.authenticationScheme = "MAIS";//fix me
                ...
                // fixme return this.auth.authenticate(this.preferences.clientId, this.preferences.clientSecret);
                return this.auth.authenticate("dd4bbbbae17e496eb116526c6a753acb", "dd4bbbbae17e496eb116526c6a753acb");
            };
